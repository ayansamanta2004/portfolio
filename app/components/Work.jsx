    ...
    return (
        <motion.div
            ...
            <motion.p
                ...
                Welcome to my web development portfolio! Explore a collection of projects that showcase my skills in building full-stack web applications.
            </motion.p>
            ...
            <motion.div
                ...
                {workData.map((project, index) => (
                    <motion.div
                        ...
                        key={index}
                        className='aspect-square bg-no-repeat bg-contain bg-center rounded-lg relative cursor-pointer group' style={{ backgroundImage: `url(${project.bgImage})` }}>
