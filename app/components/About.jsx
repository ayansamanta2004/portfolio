        ...
        >
            ...
            <motion.div
                ...
                <motion.div
                    ...
                    className='w-64 sm:w-80 lg:w-72 rounded-3xl max-w-none'>
                ...
                <motion.div
                    ...
                    <p className='mb-10 font-ovo'>
                        I am a 3rd Year Computer Science student and a Full-Stack MERN Developer with a strong interest in building scalable web applications. I enjoy working on real-world projects and have hands-on experience with technologies like React, Node.js, Express, and MongoDB. Alongside development, I actively practice competitive programming to strengthen my problem-solving skills.
                    </p>
                    <motion.ul
                        initial={{ opacity: 0 }}
                        whileInView={{ opacity: 1 }}
